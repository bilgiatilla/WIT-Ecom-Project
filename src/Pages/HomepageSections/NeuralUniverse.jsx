...
function NeuralUniverse() {
  return <section className="text-center flex flex-col lg:flex-row w-fill lg:max-w-400">
    ...
    <Link to="/shop" className="bg-[#23A6F0] border border-[#23A6F0] lg:bg-[#2DC071] lg:border-[#2DC071] text-white rounded-sm w-fit justify-self-center px-8 py-3">BUY NOW</Link>{" "}
    <button className="border text-[#23A6F0] lg:text-[#2DC071] rounded-sm w-fit justify-self-center px-8 py-3 cursor-pointer">Learn More</button>
    </div>
    </div>
